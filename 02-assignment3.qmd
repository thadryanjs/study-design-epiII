...
Most of the resource that are readily available are from specific CDC programs.
    ...
    - A study called [Patient retention in mobile and fixed-site methadone maintenance treatment], which was done on data collected via interview [@greenfieldPatientRetentionMobile1996]. This would be the most specific.
...
@greenfieldPatientRetentionMobile1996
